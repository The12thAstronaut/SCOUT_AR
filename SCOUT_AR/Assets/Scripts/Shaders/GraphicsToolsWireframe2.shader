...
Shader "Custom/Wireframe2"
{
    Properties
    {
        ...
        [Toggle(_STENCIL)]_EnableStencil("Enable Stencil Testing", Float) = 1.0
        _StencilReference("Stencil Reference", Range(0, 255)) = 2
        [Enum(UnityEngine.Rendering.CompareFunction)]_StencilComparison("Stencil Comparison", Int) = 4
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Scripts/Shader Common/GraphicsToolsCommon.hlsl"
