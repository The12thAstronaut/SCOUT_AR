...
namespace Microsoft.MixedReality.Toolkit.SpatialManipulation
{
    ...
    /// </summary>
    [AddComponentMenu("MRTK/Spatial Manipulation/Solvers/MenuFollow")]
    public class MenuFollow : Solver
    {
        ...
        private void ComputeOrientation(Vector3 goalPosition, bool needsRefresh, ref Quaternion orientation)
        {
            ...
            switch (defaultOrientationType)
            {
                ...
                case SolverOrientationType.FaceTrackedObject:
                    orientation = SolverHandler.TransformTarget != null ? Quaternion.identity : Quaternion.identity;
                    break;
